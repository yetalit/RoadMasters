...
public class CameraController : MonoBehaviour
{
        ...
        //Fast camera movement
    {
        ...
        if (Input.mousePosition.y >= Screen.height - _camBorderMovement)
        {
            newPosition += (transform.forward * _camMovementSpeed);
        }

        if (Input.mousePosition.y <= _camBorderMovement)
        {
            newPosition += (transform.forward * -_camMovementSpeed);
        }

        if (Input.mousePosition.x >= Screen.width - _camBorderMovement)
        {
            newPosition += (transform.right * _camMovementSpeed);
        }

        if (Input.mousePosition.x <= _camBorderMovement)
        {
            newPosition += (transform.right * -_camMovementSpeed);
        }
